  ...
  return (
    <>
      ...
      <main className="text-green-dark">
        ...
        {/* WHO WE ARE */}
        <section className="px-[5%] pb-20 max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <section className="bg-white px-[5%] py-24">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Tree Planting", desc: "Restoring degraded lands and rebuilding forest ecosystems." },
                { title: "Agroforestry", desc: "Integrating trees into farming to improve soil and income." },
                { title: "Community Training", desc: "Equipping locals with skills to grow and protect trees." },
                { title: "Climate Action", desc: "Using trees to combat climate change and environmental decline." },
              ].map((item) => (
                <div
                  key={item.title}
        ...
        <section className="px-[5%] py-24 max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-10 text-center">
            {[
              { num: "3,000,000+", label: "Trees Planted" },
              { num: "100,000+", label: "People Reached" },
              { num: "20+ Years", label: "Experience" },
            ].map((stat) => (
              <div key={stat.label}>
                <h3 className="font-serif text-4xl text-green-accent mb-2">{stat.num}</h3>
        ...
        <section className="px-[5%] py-24 max-w-4xl mx-auto text-center">
          <h2 className="font-serif text-4xl mb-6">Why Tree Planting Matters</h2>
          <p className="text-gray-500 leading-relaxed">
